## 🖼️ Cipher-Shadow-Image-GUI 🔐

A Python-based **Image Steganography GUI Tool** that allows you to **encrypt a secret message** and embed it inside a **PNG image**, and later **extract + decrypt** it using the correct password.
...
```bash
Cipher-Shadow-Image-GUI/
│
├── image_encrypt_gui.py     # Main GUI application
...
- Binary file hiding (not just text)
